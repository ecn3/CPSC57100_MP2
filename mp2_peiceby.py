...
class GenGameBoard: 
    ...
    def alphaBetaSearch(self):
        #set value to the result of maxValue given current state
    ...
    def maxValue(self):
        ...
        # Loop through every possible move
            ...
            # if maxValue is >= Beta keep maxValue
            # set aplah to maxValue
        # return maxValue
    ...
    def minValue(self,alpha, beta):
        ...
        utility = above
        """
        minValue = 2 # initialize minValue

        # Loop through every possible move
            # For each move set minValue to (minValue, minValue(self, alpha), alpha, beta)
            # if minValue is <= Alpha keep minValue
            # set beta to minValue
        # return minValue
